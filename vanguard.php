...
<header onclick="event.stopPropagation()"> <!-- Evita fechar ao clicar na navbar -->
    <div class="navbar-left">
        ...
        <a href="vanguard.php">
        <img src="static/Vg_new_logo.png" alt="Vanguard Logo" class="sidebar-logo">
        </a>
        <a href="index.php">
...
<div id="sidebar" class="sidebar">
    ...
    <a href="pokemon.php"><img src="static/Pokemon-Logo.png" alt="Pokémon" class="sidebar-logo"></a>
